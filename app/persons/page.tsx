  ...
  try {
    ...
    return (
      <div style={{ padding: '20px', maxWidth: '600px', margin: '0 auto', textAlign: 'center' }}>
        ...
        <p>We encountered an error while loading the people list. This might be due to:</p>
        <ul style={{ textAlign: 'left', marginBottom: '20px' }}>
          <li>Temporary connection issues</li>
          <li>Database access restrictions</li>
          <li>Server configuration</li>
        </ul>
        <p style={{ marginBottom: '20px' }}>Please try refreshing the page or signing out and back in.</p>
        <div style={{ 
          background: '#f8d7da', 
